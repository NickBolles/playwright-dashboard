  ...
  const webhookEndpoints = [
    {
      ...
      description:
        'Triggered when a pull request is opened, updated, or merged',
      icon: Github,
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex items-center space-x-2'>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        copyToClipboard(
                          getFullUrl(webhook.endpoint),
                          webhook.endpoint
                        )
                      }
                    >
                      {copiedEndpoint === webhook.endpoint ? (
                        'Copied!'
                      ) : (
        ...
        <CardContent className='space-y-4'>
          <div className='space-y-2'>
            ...
            <ol className='list-decimal list-inside space-y-1 text-sm text-muted-foreground'>
              ...
              <li>
                Select individual events: "Pull requests" and "Deployments"
              </li>
          ...
          <div className='space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>
              All webhooks require an{' '}
              <code className='bg-muted px-1 py-0.5 rounded'>
                environment_id
              </code>{' '}
              parameter to specify which environment to run tests against.
            </p>
  ...
  "custom_config": {
    ...
    "TIMEOUT": 30000
          ...
          <div className='space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>
              Webhooks are currently open endpoints. Consider implementing
              authentication and request validation for production use.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className='text-center py-8 text-muted-foreground'>
            ...
            <p className='text-sm'>
              Webhook logs will appear here once you start receiving requests
            </p>
          </div>
        </CardContent>
      </Card>
